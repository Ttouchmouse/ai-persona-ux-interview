...
export function QuickPrompts() {
  ...
  const handleRegenerate = async () => {
    ...
    // Show skeleton immediately in the initial questions slot
    setShowInitialQuestions(true);
  ...
  console.log("QuickPrompts state", {
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        {canShowInitialActions && (
          <div className="flex items-center gap-3 shrink-0">
            {/* 초기 질문 다시 보기 — always shown when initial questions exist and are hidden */}
            {!showInitialQuestions && (
              <button
            ...
            {/* 다른 질문 추천받기 — always available when initial questions exist */}
            <button
